...
본인 *다음을 포함해야 함* https://account.adobe.com 및 https://account.magento.com 모두에서 계정을 만든 다음 Adobe Commerce 계정을 사용하여 도움말 센터에 로그인하여 지원 티켓을 제출합니다. 로그인하기 전까지는 [다음 **티켓 제출** 단추가 표시되지 않습니다.](#no-submit-link).
...
<span class="wysiwyg-underline">결제 상태를 확인하는 방법</span>:
...
<span class="wysiwyg-underline">전제 조건</span>: 판매자가 부여한 공유 액세스 계정이 있습니다.
...
![디스크 위험 경고](assets/my-tickets-8.png){width-&quot;800&quot;}
...
![Adobe Commerce Cloud 애플리케이션으로 설정된 연락처 사유 및 Adobe Commerce 애플리케이션으로 설정된 연락처 사유 라이브 검색](assets/magento-env-id.png)
...
1. 에서 공유 액세스를 취소할 사용자를 찾아서 클릭합니다. ![제거 아이콘](assets/remove_icon.png){width="25"} 사용자 행(**작업** 열).
