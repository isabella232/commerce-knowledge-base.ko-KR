...
ACSD-53414 패치를 사용하면 제한된 관리 사용자가 권한 범위를 벗어난 CMS 페이지를 볼 수 있는 문제가 해결됩니다. 이 패치는 다음 경우에 사용할 수 있습니다. [[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.40이 설치되었습니다. 패치 ID는 ACSD-53414입니다. 이 문제는 Adobe Commerce 2.4.7에서 수정됩니다.
...
1. sub_expert 역할을 만들어 sub_website 및 sub_store 범위를 허용합니다. 다음 권한만 할당: [!UICONTROL Dashboard] 및 [!UICONTROL Pages].
1. 새 관리자 사용자를 만들고 sub_expert 역할에 할당합니다.
1. 다음 CSM 페이지를 sub_storeview 및 기본 storeview에 할당합니다.

   * [!UICONTROL 404 Not Found] > 하위 저장소 보기
   * [!UICONTROL 503 Service Unavailable] > 기본 저장소 보기
...
*[!UICONTROL 503 Service Unavailable]* 웹 관리자가 페이지를 볼 수 없습니다.

<u>실제 결과</u>:

*[!UICONTROL 503 Service Unavailable]* 웹 관리자가 볼 수 있습니다.
