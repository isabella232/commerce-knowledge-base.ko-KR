...
MDVA-38270 패치는 기프트 카드 금액이 고객 주문 총계에 없는 경우 문제를 해결합니다. 이 패치는 다음 경우에 사용할 수 있습니다. [품질 패치 도구(QPT)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) 1.0.25가 설치되어 있습니다. 패치 ID는 MDVA-38270입니다. 이 문제는 Adobe Commerce 2.4.3에서 수정됩니다.
